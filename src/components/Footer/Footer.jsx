            ...
            <div className='max-w-full bg-[#0F1419] text-white font-khand px-5'>
                <div className="max-w-[1400px] mx-auto">
                    <div className='grid md:grid-cols-3 grid-cols-1 gap-5 py-16'>
                        <div>
                            <div>
                                <h1 className='text-[25px] font-medium md:text-start text-center py-4'>About Agri World Expo</h1>
                            </div>
                            <div>
            ...
            <div className="max-w-full bg-[#007038] text-white font-khand font-medium px-3">
                <div className=' py-3 max-w-[1400px] mx-auto'>
                    <div className='grid grid-cols-1 md:grid-cols-2 text-center'>
                        <p className='md:text-start'>Copyright © 2025 Agri World Expo</p>
                        <p className='md:text-end'><button>Private Policy</button> Developed By <button>Clicker Solutions</button></p>
                    </div>
                </div>
            </div>
        </>
