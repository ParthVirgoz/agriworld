...
const HeroSection = () => {
    ...
    return (
        <>
            <div className="max-w-[1400px] font-khand mx-auto mt-46  md:mt-14 md:py-18">
            ...
            <div>
                <div className="bg-[#DFFFEF] max-w-[1400px] mx-auto">
                    <h1 className="font-khand font-bold text-4xl text-green-700 text-center py-10">RAJKOT, THE HEART OF SAURASHTRA IS THE RIGHT PLACE</h1>
                </div>
                <div className="max-w-[1350px] mx-auto py-10 px-4 mt-5 font-khand">
                    <div className="flex font-semibold text-[#54595F] py-4 text-[22px]">
                        <span className="text-green-700 text-4xl pr-4"><FaLocationDot /></span>Rajkot's central position in Gujarat and excellent connectivity make it easily accessible for exhibitors and attendees
                    </div>
                    <div className="flex font-semibold text-[#54595F] py-4 text-[22px]">
