  ...
  return (
    <div className="w-full font-khand fixed top-0 left-0 z-50">
      ...
      <div className="bg-green-800 text-white text-sm">
        <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 grid-cols-1 justify-between items-center px-6 py-2">
      ...
      <div className="bg-white">
        <div className="max-w-[1400px] mx-auto flex justify-between items-center px-6">
          ...
          {/* Logo */}
          <img src="/assets/Logo.png" alt="logo1" className="h-22 w-22" />
